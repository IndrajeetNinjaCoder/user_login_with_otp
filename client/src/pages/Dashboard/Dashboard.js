...
import salesChart from '../Dashboard/style/images/dashboard/chart.png';
import Purchases from '../Dashboard/style/images/dashboard/purchases.png';
        ...
        <div className="main-panel">
            ...
            <div className="row">
              <div className="col-md-12 grid-margin">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <h4 className="font-weight-normal mb-0">RoyalUI Dashboard</h4>
                  </div>
                  <div>
            ...
            <div className="row">
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div id="sales-chart">
                      <img src={salesChart} alt="Sales Chart" style={{ width: "100%" }} />
                    </div>
                  </div>
                    ...
                    <div className="d-flex justify-content-center justify-content-md-end">
                      <div className="dropdown flex-md-grow-1 flex-xl-grow-0">
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                          <NavLink className="dropdown-item" to="#">January - March</NavLink>
                          <NavLink className="dropdown-item" to="#">March - June</NavLink>
                          <NavLink className="dropdown-item" to="#">June - August</NavLink>
                          <NavLink className="dropdown-item" to="#">August - November</NavLink>
                        </div>
                      </div>
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card border-bottom-0">
                  ...
                  <div id="order-chart" className="w-100">
                    <img src={Purchases} style={{ width: "100%" }} alt="Purchases" />
                  </div>
                </div>
              </div>
            </div>
                                ...
                                <tr>
                                  ...
                                  <td className="w-100 px-0">
                                    <div className="progress progress-md mx-4">
                                      <div className="progress-bar bg-primary" role="progressbar" style={mystyle}></div>
                                    </div>
                                  </td>
          ...
          <footer className="footer">
            <div className="d-sm-flex justify-content-center justify-content-sm-between">
              <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <NavLink to="#">bootstrapdash.com </NavLink>2021</span>
              <span className="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Only the best <NavLink to="#"> Bootstrap dashboard </NavLink> templates</span>
            </div>
          </footer>
